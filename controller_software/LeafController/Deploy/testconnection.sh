...
####################################################################################
#
# Test connection on remote computer
...
localhelp () {
  echo "Usage:"
  echo "  testconnection.sh remote_IP|file_with_remote_IPs rootpwd"
  echo "    Test connection on remote computer(s)"
}

executeScript () {
  REMOTECMD="echo \"Connection OK\" "
