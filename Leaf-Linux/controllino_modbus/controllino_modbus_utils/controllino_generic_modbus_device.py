...
class ModbusDevice():
    def __init__(self, deviceSettings, coRegisterList = None, diRegisterList = None, hrRegisterList = None, irRegisterList = None, assignVirtualRegisters = None):
        ...
        self.assignVirtualRegisters = assignVirtualRegisters
    ...
    def readAll(self):
        ...
        # After polling all the modbus variables assign the modbus virtual variables
        if self.assignVirtualRegisters is not None:
            self.assignVirtualRegisters(self.coDataFrame, self.diDataFrame, self.hrDataFrame, self.irDataFrame)
