...
def clientsInit(settings):
    ...
    controllinoDev = ControllinoDevice(settings)
...
def serverInit(settings): 
    ...
    def getVirtualSlaveRegisterList(settings):

        list = []

        if settings.clientOnAirCooledCube == True:
            entriesCont = [
                    ['vdContDoor1',                  controllinoDev.irDataFrame.loc['door1',                   'address'], settings.controllino, 0xFF, 'ro'], # '''00'''
                    ['vdContReserved1',              controllinoDev.irDataFrame.loc['reserved1',               'address'], settings.controllino, 0xFF, 'ro'], # '''00'''
                    ['vdContReserved2',              controllinoDev.irDataFrame.loc['reserved2',               'address'], settings.controllino, 0xFF, 'ro'], # '''00'''
                    ['vdFanAlarm1',                  controllinoDev.irDataFrame.loc['fanAlarm1',               'address'], settings.controllino, 0xFF, 'ro'], # '''00'''
                    ['vdFanAlarm2',                  controllinoDev.irDataFrame.loc['fanAlarm2',               'address'], settings.controllino, 0xFF, 'ro'], # '''00'''
                    ['vdFanAlarm3',                  controllinoDev.irDataFrame.loc['fanAlarm3',               'address'], settings.controllino, 0xFF, 'ro'], # '''00'''
                    ['vdFanAlarm4',                  controllinoDev.irDataFrame.loc['fanAlarm4',               'address'], settings.controllino, 0xFF, 'ro'], # '''00'''
                    ['vdFanAlarm5',                  controllinoDev.irDataFrame.loc['fanAlarm5',               'address'], settings.controllino, 0xFF, 'ro'], # '''00'''
                    ...
                    ['vdContPowerSupp1',             controllinoDev.irDataFrame.loc['powerSupp1',              'address'], settings.controllino, 0xFF, 'ro'], # '''11'''
                    ['vdContPowerSupp2',             controllinoDev.irDataFrame.loc['powerSupp2',              'address'], settings.controllino, 0xFF, 'ro'], # '''12'''
                    ['vdFanAlarm6',                  controllinoDev.irDataFrame.loc['fanAlarm6',               'address'], settings.controllino, 0xFF, 'ro'], # '''00'''
                    ['vdFanAlarm7',                  controllinoDev.irDataFrame.loc['fanAlarm7',               'address'], settings.controllino, 0xFF, 'ro'], # '''00'''
                    ['vdFanAlarm8',                  controllinoDev.irDataFrame.loc['fanAlarm8',               'address'], settings.controllino, 0xFF, 'ro'], # '''00'''
        ...
        if settings.hvac1.type == 'BlackShields':
            entriesHvac1 = [
                ['vd' + str(settings.hvac1.name) + 'AnyAlarm',            HvacDevice(settings.hvac1).coDataFrame.loc['highAndLowTempAlarm', 'address'], settings.hvac1, 0xFF, 'ro'],  # '''40'''
                ['vd' + str(settings.hvac1.name) + 'refrigStopPoint',     HvacDevice(settings.hvac1).hrDataFrame.loc['refrigSetPoint', 'address'],      settings.hvac1, 0xFF, 'rw'],  # '''41'''
                ['vd' + str(settings.hvac1.name) + 'Heartbeat',           0,                                                                  settings.hvac1, 0xFF, 'ro'],  # '''42''' # Heartbeat does not exist
                    ]

        else:
            entriesHvac1 = [
                ['vd' + str(settings.hvac1.name) + 'AnyAlarm',            HvacDevice(settings.hvac1).hrDataFrame.loc['highTempAlarm', 'address'],       settings.hvac1, 0xFF, 'ro'],  # '''40'''
                ['vd' + str(settings.hvac1.name) + 'refrigStopPoint',     HvacDevice(settings.hvac1).hrDataFrame.loc['refrigStopPoint', 'address'],     settings.hvac1, 0xFF, 'rw'],  # '''41'''
                ['vd' + str(settings.hvac1.name) + 'Heartbeat',           0,                                                                  settings.hvac1, 0xFF, 'ro'],  # '''42''' # Heartbeat does not exist
                ['vd' + str(settings.hvac1.name) + 'unitRunningStatus',   HvacDevice(settings.hvac1).hrDataFrame.loc['unitRunningStatus', 'address'],   settings.hvac1, 0xFF, 'ro'],  # '''43'''
                            ]

        if settings.hvac2.type == 'BlackShields':
            entriesHvac2 = [
                ['vd' + str(settings.hvac2.name) + 'AnyAlarm',            HvacDevice(settings.hvac2).coDataFrame.loc['highAndLowTempAlarm', 'address'], settings.hvac2, 0xFF, 'ro'],  # '''40'''
                ['vd' + str(settings.hvac2.name) + 'refrigStopPoint',     HvacDevice(settings.hvac2).hrDataFrame.loc['refrigSetPoint', 'address'],      settings.hvac2, 0xFF, 'rw'],  # '''41'''
                ['vd' + str(settings.hvac2.name) + 'Heartbeat',           0,                                                                  settings.hvac2, 0xFF, 'ro'],  # '''42''' # Heartbeat does not exist
                    ]

        else:
            entriesHvac2 = [
                ['vd' + str(settings.hvac2.name) + 'AnyAlarm',            HvacDevice(settings.hvac2).hrDataFrame.loc['highTempAlarm', 'address'],       settings.hvac2, 0xFF, 'ro'],  # '''40'''
                ['vd' + str(settings.hvac2.name) + 'refrigStopPoint',     HvacDevice(settings.hvac2).hrDataFrame.loc['refrigStopPoint', 'address'],     settings.hvac2, 0xFF, 'rw'],  # '''41'''
                ['vd' + str(settings.hvac2.name) + 'Heartbeat',           0,                                                                  settings.hvac2, 0xFF, 'ro'],  # '''42''' # Heartbeat does not exist
                ['vd' + str(settings.hvac2.name) + 'unitRunningStatus',   HvacDevice(settings.hvac2).hrDataFrame.loc['unitRunningStatus', 'address'],   settings.hvac1, 0xFF, 'ro'],  # '''43'''
                            ]


        list.extend(entriesHvac1)
        list.extend(entriesHvac2)
        ...
        list.extend(entriesRest)

        return list

    virtualSlaveRegisterList = getVirtualSlaveRegisterList(settings)
...
def getVirtualSlaveValues(settings, localDf):
    ...
    if settings.clientOnAirCooledCube == True:
        ...
        localDf.loc['vdContReserved2', 'value'] = controllinoDev.irDataFrame.loc['reserved2', 'value']
        localDf.loc['vdFanAlarm1', 'value'] = controllinoDev.irDataFrame.loc['fanAlarm1', 'value']
        localDf.loc['vdFanAlarm2', 'value'] = controllinoDev.irDataFrame.loc['fanAlarm2', 'value']
        localDf.loc['vdFanAlarm3', 'value'] = controllinoDev.irDataFrame.loc['fanAlarm3', 'value']
        localDf.loc['vdFanAlarm4', 'value'] = controllinoDev.irDataFrame.loc['fanAlarm4', 'value']
        localDf.loc['vdFanAlarm5', 'value'] = controllinoDev.irDataFrame.loc['fanAlarm5', 'value']
        ...
        localDf.loc['vdContPowerSupp1', 'value'] = controllinoDev.irDataFrame.loc['powerSupp1', 'value']
        localDf.loc['vdContPowerSupp2', 'value'] = controllinoDev.irDataFrame.loc['powerSupp2', 'value']
        localDf.loc['vdFanAlarm6', 'value'] = controllinoDev.irDataFrame.loc['fanAlarm6', 'value']
        localDf.loc['vdFanAlarm7', 'value'] = controllinoDev.irDataFrame.loc['fanAlarm7', 'value']
        localDf.loc['vdFanAlarm8', 'value'] = controllinoDev.irDataFrame.loc['fanAlarm8', 'value']
...
def readClientsWriteToServer(log, settings, context):
    ...
    if settings.controllino.use == True:
        ...
        for i in controllinoDev.hrDataFrame.index:
            values = [controllinoDev.hrDataFrame.loc[i, 'value']]
            #context[settings.controllino.unitId].setValues(settings, holdingregister, controllinoDev.coDataFrame.loc[i, 'address'], values, setQueue = False)
            context[settings.controllino.unitId].setValues(holdingregister, controllinoDev.hrDataFrame.loc[i, 'address'], values, setQueue = False)
