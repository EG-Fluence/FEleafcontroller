...
def AC_Cube_Controller():
    ...
    while True:
        ...
        try:
            ...
            # oldRefrigStopPoint1 = HVAC_AC_CubeWrite(client, hvac2_cct, oldRefrigStopPoint1, scriptSettings.hvac1)
            # oldRefrigStopPoint2 = HVAC_AC_CubeWrite(client, hvac2_cct, oldRefrigStopPoint2, scriptSettings.hvac2)

            #emergency
            if hvac2_cct > 230:
                HVAC_AC_CubeWrite(client, 160, scriptSettings.hvac1)
                HVAC_AC_CubeWrite(client, 160, scriptSettings.hvac2)
            if hvac2_cct < 190:
                HVAC_AC_CubeWrite(client, 260, scriptSettings.hvac1)
                HVAC_AC_CubeWrite(client, 260, scriptSettings.hvac2)
...
if scriptSettings.clientOnCube == True:
    print("")
    print("Running on Cube")
    print("")
    Cube_Controller()

if scriptSettings.clientOnAirCooledCube == True:
    print("")
    print("Running on AirCooledCube")
    print("")
    AC_Cube_Controller()
